<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PageThree.aspx.cs" Inherits="WebApplication1.PageThree" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    width: 50%;
     ...
     <h5>Replacement Medication Order Form</h5>
        ...
        <input type="text" />
        <br />
        <label>Prescription Replacement Information:</label>
        <input type="text" />
        <br />
